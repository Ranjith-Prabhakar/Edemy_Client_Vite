...
const Profile = ({ sideBarData }: Props) => {
  ...
  return (
    <div className=" custom-scrollBar 400px:flex flex-col h-screen overflow-scroll w-full m-auto rounded-lg text-xl bg-c_color-colorOne shadow-md ring-gray-400 space-y-3">
