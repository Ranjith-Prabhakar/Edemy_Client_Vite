...
const SideBar = ({ sideBarData }: Props) => {
  ...
  return (
    <div className=" custom-scrollBar hidden 800px:flex flex-col h-full overflow-scroll  max-w-[15%] w-full m-auto rounded-lg text-xl dark:bg-c_color-colorOne shadow-md ring-gray-400 space-y-3">
